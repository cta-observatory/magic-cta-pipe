        ...
        if os.path.exists(MAGIC_DL1_dir + "/M1"):
            ...
            for i in dates:
                ...
                for r in runs:
                    ...
                    if not os.path.exists(MAGIC_DL1_dir + f"/Merged/{i}/{r}/log"):
                        os.mkdir(
                            f"{MAGIC_DL1_dir}/Merged/{i}/{r}/log"
                        )  # Creating a merged directory for the respective run

                    f.write(
                        f"conda run -n magic-lst python {scripts_dir}/merge_hdf_files.py --input-dir {MAGIC_DL1_dir}/M1/{i}/{r} --output-dir {MAGIC_DL1_dir}/Merged/{i}/{r} >{MAGIC_DL1_dir}/Merged/{i}/{r}/log/merge_M1_{i}_{r}.log \n"
                    )
        ...
        if os.path.exists(MAGIC_DL1_dir + "/M2"):
            ...
            for i in dates:
                ...
                for r in runs:
                    ...
                    f.write(
                        f"conda run -n magic-lst python {scripts_dir}/merge_hdf_files.py --input-dir {MAGIC_DL1_dir}/M2/{i}/{r} --output-dir {MAGIC_DL1_dir}/Merged/{i}/{r} >{MAGIC_DL1_dir}/Merged/{i}/{r}/log/merge_M2_{i}_{r}.log \n"
                    )
