                ...
                if (
                    ...
                    if telescope_ids[-1] > 0:
                        ...
                        lines = [
                            ...
                            f"time conda run -n {env_name} python {scripts_dir}/magic_calib_to_dl1.py --input-file $SAMPLE --output-dir $OUTPUTDIR --config-file {target_dir}/config_step1.yaml >$LOG 2>&1\n",
                        ]
                        with open(
