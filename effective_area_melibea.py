...
p = dict()
p['events'], p['simulation_info'] = read_dl2_file("/storage/gpfs_data/ctalocal/aberti/Analysis_MAGIC/OFFS/Coach_ST0312/05to70/Melibea_MC/GA_za05to35_8_Q_w0_2.root")
gammas = p['events']

reco = gammas.to_pandas()
print(len(reco.index))
reco_valid = reco[reco["reco_energy"] > 0]
...
print(len(reco_selected_h.index))
...
print(len(reco_selected_th.index))
