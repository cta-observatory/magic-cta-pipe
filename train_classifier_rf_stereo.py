...
def load_data_sample(input_file, ismc):
...
mc_data = load_data_sample(config['data_files']['mc']['train_sample']['magic']['hillas_output'], True)

info_message('Loading "off" train data...', prefix='ClassifierRF')
bkg_data = load_data_sample(config['data_files']['data']['train_sample']['magic']['hillas_output'], False)
...
mc_data = load_data_sample(config['data_files']['mc']['test_sample']['magic']['hillas_output'], True)

info_message('Loading "off" test data...', prefix='ClassifierRF')
bkg_data = load_data_sample(config['data_files']['data']['test_sample']['magic']['hillas_output'], False)
