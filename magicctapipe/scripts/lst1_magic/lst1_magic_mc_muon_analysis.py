...
def mc_dl0_to_muons(input_file, output_dir, config, plots_path):
    ...
    r1_dl1_calibrator_for_muon_rings['LST'] = CameraCalibrator(subarray, image_extractor=extractor_lst_muons)
    # Use the standard MAGIC calibration and charextraction to be comparable with MAGIC data
    extractor_magic_muons = ImageExtractor.from_name(extractor_type_magic,
