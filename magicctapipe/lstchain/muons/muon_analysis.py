...
def update_parameters(config, n_pixels):
    ...
    params = {
        ...
        "max_radial_stdev": 0.1
        * u.deg,  # maximum standard deviation of the light distribution along ring radius
...
def analyze_muon_event(
    subarray, tel_id, event_id, image, good_ring_config, plot_rings, plots_path
):
    """
    ...
    cam_rad = (
        tel_description.camera.geometry.guess_radius()
        / tel_description.optics.equivalent_focal_length
    ) * u.rad
