...
__all__ = ["lst1_magic_mc_dl0_to_dl1_jobs"]
...
lst1_magic_mc_dl0_to_dl1 -i $INPUT_FILE -o {{ output_dir }} -c {{ config_file }}

"""

def lst1_magic_mc_dl0_to_dl1_jobs(
	input_files, output_dir, config_file, submit
):
	file_list = [
    ...
    job_dict = {
        "job_name": "lst1_magic_mc_dl0_to_dl1",
        "stop_job": n_jobs - 1,
    ...
    job_submit_filename = "lst1_magic_mc_dl0_to_dl1.slurm"
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Script to create and optionally submit jobs for lst1_magic_mc_dl0_to_dl1 script.",
        prefix_chars="-",
    )
    ...
    lst1_magic_mc_dl0_to_dl1_jobs(
        input_file, output_dir,config_file, submit
    )
