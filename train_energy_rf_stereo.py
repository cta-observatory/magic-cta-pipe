...
shower_data_train = load_data_sample(config['data_files']['mc']['train_sample']['magic']['hillas_output'], True)
...
shower_data_test = load_data_sample(config['data_files']['mc']['test_sample']['magic']['hillas_output'], True)
